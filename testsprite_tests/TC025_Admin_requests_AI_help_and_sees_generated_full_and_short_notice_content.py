...
async def run_test():
    ...
    try:
        ...
        # -> Type username into email field (index 615) and password into password field (index 616), then click 'Iniciar sesión' (index 618).
        ...
        # -> Click 'Gestión Admin' in the main navigation (element index 927) to open admin options.
        frame = context.pages[-1]
        # Click element
